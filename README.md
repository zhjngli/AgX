...
- **CLI and API first**: AgX is a library and a command-line tool. The core value is the portable preset format; the library and CLI are how you drive the engine that renders it.
